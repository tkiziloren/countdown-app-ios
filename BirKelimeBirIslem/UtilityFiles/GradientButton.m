...
- (CGGradientRef)normalGradient
{
    if (normalGradient == NULL)
    {
        ...
        normalGradient = CGGradientCreateWithColors(space, (  CFArrayRef)CFBridgingRetain(normalGradientColors), locations);
...
- (CGGradientRef)highlightGradient
{
    ...
    if (highlightGradient == NULL)
    {
        ...
        highlightGradient = CGGradientCreateWithColors(space, ( CFArrayRef)CFBridgingRetain(highlightGradientColors), locations);
        CGColorSpaceRelease(space);
    }
